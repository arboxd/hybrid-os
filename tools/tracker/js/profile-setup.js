/**
 * profile-setup.js
 * Pantalla de bienvenida y configuración inicial de perfil.
 * Se muestra solo si no hay perfil guardado en localStorage.
 */

// ============================
// Perfil por defecto de Obed
// (editable por cada usuario)
// ============================
...
// ============================
// Render de pantalla de bienvenida
// ============================
export function renderProfileSetup(onComplete) {
  ...
  screen.innerHTML = `
    ...
    <div class="setup-container">
      ...
      <div class="setup-logo">
        ...
        <h1 class="setup-logo-title">HYBRID TRACKER</h1>
      ...
      <form class="setup-form" id="setup-form" novalidate>
        ...
        <div class="setup-step active" id="step-1">
          ...
          <div class="form-group">
            ...
            <span class="form-hint">
              Así te identificarás en el tracker
            </span>
          </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label class="form-label" for="setup-weight">
                Peso (kg)
              </label>
              <input
                class="form-input"
            ...
            <div class="form-group">
              <label class="form-label" for="setup-height">
                Altura (cm)
              </label>
              <input
                class="form-input"
          ...
          <div class="form-group">
            <label class="form-label" for="setup-goal">
              Objetivo Principal
            </label>
        ...
        <div class="setup-step" id="step-2">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label class="form-label" for="setup-sleep">
                😴 Sueño (h)
              </label>
              <input
                class="form-input"
            ...
            <div class="form-group">
              <label class="form-label" for="setup-hydration">
                💧 Hidratación (L)
              </label>
              <input
                class="form-input"
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label class="form-label" for="setup-hrv">
                💪 HRV (ms)
              </label>
              <input
                class="form-input"
            ...
            <div class="form-group">
              <label class="form-label" for="setup-hr">
                ❤️ FC Reposo (bpm)
              </label>
              <input
                class="form-input"
        ...
        <div class="setup-step" id="step-3">
          ...
          <p class="setup-note">
            ...
            momento desde la sección de Recovery o Perfil.
          </p>
  ...
  _bindSetupEvents(onComplete);
}

// ============================
// Lógica de pasos
// ============================
function _bindSetupEvents(onComplete) {
  let currentStep = 1;
...
function _fillSummary() {
  ...
  const age       = document.getElementById('setup-age').value       || 30;
  const weight    = document.getElementById('setup-weight').value    || 80;
  const height    = document.getElementById('setup-height').value    || 175;
...
// Guardar perfil
// ============================
function _saveProfile(onComplete) {
  const profile = {
